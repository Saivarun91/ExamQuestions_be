...
def get_dashboard_data(request):
    ...
    try:
        ...
        try:
            ...
            # Filter coupons: EXCLUDE common coupons - only show user-specific coupons or used coupons
            all_coupons = {}
            for coupon in all_active_coupons:
                # Skip common/public coupons - they are available to all users and shouldn't show in dashboard
                if coupon.is_common:
                    continue
                ...
                # Include only if: user has used it OR it's assigned to this specific user (NOT common coupons)
            ...
            for coupon in all_coupons.values():
                ...
                # Check expiry
                is_expired = False
                if hasattr(coupon, 'valid_until') and coupon.valid_until:
                    is_expired = coupon.valid_until < datetime.datetime.utcnow()
                ...
                coupons.append({
                    ...
                    "user_already_used": user_has_used,  # Add this for frontend filtering
                    "is_expired": is_expired,
                    "is_active": coupon.is_active if hasattr(coupon, 'is_active') else True,

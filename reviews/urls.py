...
urlpatterns = [
    # Verify coupon endpoints - place at top to ensure they're matched first
    path('verify-coupon/', verify_coupon, name='verify_coupon_alt'),  # With trailing slash
    path('verify-coupon', verify_coupon, name='verify_coupon_no_slash'),  # Without trailing slash

MASTER_TRANSLATION_KEYS = {
    ...
    "footer.disclaimer_text": (
        "All trademarks, certification names, course titles, and logos displayed on this "
        "website are the property of their respective owners and are used solely for "
        "identification and informational purposes. AllExamQuestions is an independent exam "
        "preparation platform and is not affiliated with, endorsed by, authorized by, or "
        "sponsored by any exam provider, certification body, or brand mentioned on this website."
    ),
    ...
    "home.hero.subtitle": (
        ...
        "preparing for their next big certification."
    ),

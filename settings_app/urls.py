...
urlpatterns = [
    ...
    path('editor-policy/', views.get_editor_policy, name='get_editor_policy'),
    path('editor-policy/update/', views.update_editor_policy, name='update_editor_policy'),
    path('footer/', views.get_footer_settings, name='get_footer_settings'),
    path('footer/update/', views.update_footer_settings, name='update_footer_settings'),
